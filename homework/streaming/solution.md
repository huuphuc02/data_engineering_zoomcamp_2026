...
Submit job:
```bash
docker exec -it workshop-jobmanager-1 flink run -py /opt/src/job/aggregation_job_q4.py
```
...
Submit job:
```bash
docker exec -it workshop-jobmanager-1 flink run -py /opt/src/job/aggregation_job_q5.py
```
...
- 2025-10-01 18:00:00
- 2025-10-16 18:00:00 x
- 2025-10-22 08:00:00
- 2025-10-30 16:00:00

Submit job:
```bash
docker exec -it workshop-jobmanager-1 flink run -py /opt/src/job/aggregation_job_q6.py
```
